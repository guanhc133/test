...
<div id="wrapper">
    ...
    <div class="container">
        <div class="con_content">
            <div class="about_box">
                <h2 class="nh1"><span>您现在的位置是：<a href="/" target="_blank">网站首页</a>>><a href="#" target="_blank">个人日记</a></span><b>个人日记</b>
                </h2>
                <div class="dtxw box">
                    <li>
                        ...
                        <div class="xwpic f_r"><a href="/"><img src="<%=path %>/images/02.jpg"></a></div>
                    </li>
                    <li>
                        <div class="dttext f_l">
                            <ul>
                        ...
                        <div class="xwpic f_r"><a href="/"><img src="<%=path %>/images/01.jpg"></a></div>
                    </li>
                    <li>
                        <div class="dttext f_l">
                            <ul>
                        ...
                        <div class="xwpic f_r"><a href="/"><img src="<%=path %>/images/03.jpg"></a></div>
                    </li>
                    <li>
                        <div class="dttext f_l">
                            <ul>
                        ...
                        <div class="xwpic f_r"><a href="/"><img src="<%=path %>/images/04.jpg"></a></div>
                    </li>
                    <li>
                        <div class="dttext f_l">
                            <ul>
                    ...
                    <li>
                        ...
                        <div class="xwpic f_r"><a href="/"><img src="<%=path %>/images/06.jpg"></a></div>
                    </li>
                </div>
                <div class="pagelist">页次：1/1 每页25 总数10<a href="/">首页</a><a href="/">上一页</a><a href="/">下一页</a><a
                        href="/">尾页</a></div>
            </div>
        </div>
        <div class="blank"></div>
